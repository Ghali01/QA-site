...
import { deepMerge, startStickyObservers, STICKY_OBSERVER_CLASS, escapeHTML, } from "../shared/utils";
 ...
 */
var StacksEditor = /** @class */ (function () {
    ...
    Object.defineProperty(StacksEditor.prototype, "editorView", {
        get: function () {
            var _a;
    ...
    StacksEditor.prototype.setupPluginContainer = function () {
        ...
        var menuContainerFn = function () { return menuTarget; };
        ...
        var pluginContainerFn = function () { return pluginTarget; };
    ...
    StacksEditor.prototype.setBackingView = function (type, content) {
        ...
        (_a = this.innerTarget.classList).add.apply(_a, this.options.targetClassList);
        if (type === EditorType.RichText) {
            this.backingView = new RichTextEditor(this.innerTarget, content, deepMerge(this.options, this.options.richTextOptions));
        }
        else if (type === EditorType.Commonmark) {
            this.backingView = new CommonmarkEditor(this.innerTarget, content, deepMerge(this.options, this.options.commonmarkOptions));
        }
        else {
        ...
        this.backingView.editorView.props.handleDOMEvents = {
            focus: function () {
                _this.innerTarget.classList.add("bs-ring", "bc-blue-300");
                return false;
            },
            blur: function () {
                _this.innerTarget.classList.remove("bs-ring", "bc-blue-300");
                return false;
            },
        };
    ...
    StacksEditor.prototype.createEditorSwitcher = function (defaultItem, menuTarget) {
        var checkedProp = defaultItem === EditorType.Commonmark ? "checked" : "";
        var container = document.createElement("div");
        container.className = "flex--item d-flex ai-center ml24 fc-medium";
        // TODO localization
        container.innerHTML = escapeHTML(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<label class=\"flex--item fs-caption mr4 sm:d-none\" for=\"js-editor-toggle-", "\">Markdown</label>\n            <label class=\"flex--item mr4 d-none sm:d-block\" for=\"js-editor-toggle-", "\">\n                <span class=\"icon-bg iconMarkdown\"></span>\n            </label>\n            <div class=\"flex--item s-toggle-switch js-editor-mode-switcher\">\n                <input class=\"js-editor-toggle-state\" id=\"js-editor-toggle-", "\" type=\"checkbox\" ", "/>\n                <div class=\"s-toggle-switch--indicator\"></div>\n            </div>"], ["<label class=\"flex--item fs-caption mr4 sm:d-none\" for=\"js-editor-toggle-", "\">Markdown</label>\n            <label class=\"flex--item mr4 d-none sm:d-block\" for=\"js-editor-toggle-", "\">\n                <span class=\"icon-bg iconMarkdown\"></span>\n            </label>\n            <div class=\"flex--item s-toggle-switch js-editor-mode-switcher\">\n                <input class=\"js-editor-toggle-state\" id=\"js-editor-toggle-", "\" type=\"checkbox\" ", "/>\n                <div class=\"s-toggle-switch--indicator\"></div>\n            </div>"])), this.internalId, this.internalId, this.internalId, checkedProp);
        container.title = "Toggle Markdown editing";
        container
            .querySelector("#js-editor-toggle-" + this.internalId)
            .addEventListener("change", this.editorSwitcherChangeHandler.bind(this));
    ...
    StacksEditor.prototype.editorSwitcherChangeHandler = function (e) {
        ...
        e.preventDefault();
        // get opposing type
        var type = this.currentViewType === EditorType.Commonmark
            ? EditorType.RichText
            : EditorType.Commonmark;
        // set the view type for this button
        this.setView(type);
        // ensure the checkbox matches the selected editor
        this.target.querySelector("#js-editor-toggle-" + this.internalId).checked = type === EditorType.Commonmark;
    ...
    StacksEditor.READONLY_CLASSES = ["s-input__readonly"];
    return StacksEditor;
}());
export { StacksEditor };
