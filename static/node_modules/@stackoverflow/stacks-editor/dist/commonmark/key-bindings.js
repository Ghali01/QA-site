...
import { boldCommand, emphasisCommand, inlineCodeCommand, indentCommand, insertLinkCommand, blockquoteCommand, insertImageCommand, orderedListCommand, unorderedListCommand, headerCommand, insertHorizontalRuleCommand, insertCodeblockCommand, } from "./commands";
export var commonmarkKeymap = keymap({
    "Mod-z": undo,
    "Mod-y": redo,
    "Mod-Shift-z": redo,
    "Tab": indentCommand,
