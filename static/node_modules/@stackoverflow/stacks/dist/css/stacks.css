...
.s-modal {
  ...
  transition: opacity 100ms cubic-bezier(0.165, 0.84, 0.44, 1) 0s, z-index 0s 100ms, visibility 0s 100ms;
...
.s-modal[aria-hidden="false"] .s-modal--dialog {
  ...
  transition: opacity 100ms cubic-bezier(0.165, 0.84, 0.44, 1) 10ms, z-index 0s 0s, visibility 0s 0s, transform 100ms cubic-bezier(0.165, 0.84, 0.44, 1) 10ms, transform 100ms cubic-bezier(0.165, 0.84, 0.44, 1) 10ms;
}
.s-modal--dialog {
  overflow-y: auto;
  visibility: hidden;
  ...
  scrollbar-color: var(--scrollbar) transparent;
  transition: opacity 200ms cubic-bezier(0.165, 0.84, 0.44, 1) 0s, z-index 0s 100ms, visibility 0s 100ms, transform 100ms cubic-bezier(0.165, 0.84, 0.44, 1) 0s, transform 100ms cubic-bezier(0.165, 0.84, 0.44, 1) 0s;
...
.flex__fl-shrink0,
.grid__fl0 > .grid,
.grid__fl-shrink0 > .grid,
.flex__fl-shrink0 > .grid,
.grid__fl0 > .d-flex,
.grid__fl-shrink0 > .d-flex,
.flex__fl-shrink0 > .d-flex,
.grid__fl0 > .grid--cell,
.grid__fl-shrink0 > .grid--cell,
.flex__fl-shrink0 > .grid--cell,
.grid__fl0 > .flex--item,
.grid__fl-shrink0 > .flex--item,
...
.grid__fl-equal > .grid,
.flex__fl-equal > .grid,
.grid__fl-equal > .d-flex,
.flex__fl-equal > .d-flex,
.grid__fl-equal > .grid--cell,
.flex__fl-equal > .grid--cell,
.grid__fl-equal > .flex--item,
...
.flex__allcells1 > .grid,
.grid__allcells1 > .d-flex,
.flex__allcells1 > .d-flex,
.grid__allcells1 > .grid--cell,
.flex__allcells1 > .grid--cell,
.grid__allcells1 > .flex--item,
.flex__allcells1 > .flex--item {
  flex-basis: 8.33333333%;
}
.grid__allcells2 > .grid,
.flex__allcells2 > .grid,
.grid__allcells2 > .d-flex,
.flex__allcells2 > .d-flex,
.grid__allcells2 > .grid--cell,
.flex__allcells2 > .grid--cell,
.grid__allcells2 > .flex--item,
.flex__allcells2 > .flex--item {
  flex-basis: 16.66666667%;
}
.grid__allcells3 > .grid,
.flex__allcells3 > .grid,
.grid__allcells3 > .d-flex,
.flex__allcells3 > .d-flex,
.grid__allcells3 > .grid--cell,
.flex__allcells3 > .grid--cell,
.grid__allcells3 > .flex--item,
.flex__allcells3 > .flex--item {
  flex-basis: 25%;
}
.grid__allcells4 > .grid,
.flex__allcells4 > .grid,
.grid__allcells4 > .d-flex,
.flex__allcells4 > .d-flex,
.grid__allcells4 > .grid--cell,
.flex__allcells4 > .grid--cell,
.grid__allcells4 > .flex--item,
.flex__allcells4 > .flex--item {
  flex-basis: 33.33333333%;
}
.grid__allcells5 > .grid,
.flex__allcells5 > .grid,
.grid__allcells5 > .d-flex,
.flex__allcells5 > .d-flex,
.grid__allcells5 > .grid--cell,
.flex__allcells5 > .grid--cell,
.grid__allcells5 > .flex--item,
.flex__allcells5 > .flex--item {
  flex-basis: 41.66666667%;
}
.grid__allcells6 > .grid,
.flex__allcells6 > .grid,
.grid__allcells6 > .d-flex,
.flex__allcells6 > .d-flex,
.grid__allcells6 > .grid--cell,
.flex__allcells6 > .grid--cell,
.grid__allcells6 > .flex--item,
.flex__allcells6 > .flex--item {
  flex-basis: 50%;
}
.grid__allcells7 > .grid,
.flex__allcells7 > .grid,
.grid__allcells7 > .d-flex,
.flex__allcells7 > .d-flex,
.grid__allcells7 > .grid--cell,
.flex__allcells7 > .grid--cell,
.grid__allcells7 > .flex--item,
.flex__allcells7 > .flex--item {
  flex-basis: 58.33333333%;
}
.grid__allcells8 > .grid,
.flex__allcells8 > .grid,
.grid__allcells8 > .d-flex,
.flex__allcells8 > .d-flex,
.grid__allcells8 > .grid--cell,
.flex__allcells8 > .grid--cell,
.grid__allcells8 > .flex--item,
.flex__allcells8 > .flex--item {
  flex-basis: 66.66666667%;
}
.grid__allcells9 > .grid,
.flex__allcells9 > .grid,
.grid__allcells9 > .d-flex,
.flex__allcells9 > .d-flex,
.grid__allcells9 > .grid--cell,
.flex__allcells9 > .grid--cell,
.grid__allcells9 > .flex--item,
.flex__allcells9 > .flex--item {
  flex-basis: 75%;
}
.grid__allcells10 > .grid,
.flex__allcells10 > .grid,
.grid__allcells10 > .d-flex,
.flex__allcells10 > .d-flex,
.grid__allcells10 > .grid--cell,
.flex__allcells10 > .grid--cell,
.grid__allcells10 > .flex--item,
.flex__allcells10 > .flex--item {
  flex-basis: 83.33333333%;
}
.grid__allcells11 > .grid,
.flex__allcells11 > .grid,
.grid__allcells11 > .d-flex,
.flex__allcells11 > .d-flex,
.grid__allcells11 > .grid--cell,
.flex__allcells11 > .grid--cell,
.grid__allcells11 > .flex--item,
.flex__allcells11 > .flex--item {
  flex-basis: 91.66666667%;
}
.grid__allcells12 > .grid,
.flex__allcells12 > .grid,
.grid__allcells12 > .d-flex,
.flex__allcells12 > .d-flex,
.grid__allcells12 > .grid--cell,
.flex__allcells12 > .grid--cell,
.grid__allcells12 > .flex--item,
...
.s-block-link.is-selected.s-block-link__right {
  box-shadow: inset -3px 0 0 var(--orange-400);
}
...
.s-toast {
  ...
  transition: transform 100ms cubic-bezier(0.25, 0.46, 0.45, 0.94) 0s, opacity 60ms cubic-bezier(0.25, 0.46, 0.45, 0.94) 0ms, visibility 0s 150ms;
  pointer-events: none;
}
.s-toast[aria-hidden="false"] {
  ...
  opacity: 1;
  transform: translate3d(0, 0, 0);
  transition: visibility 0s 0s, opacity 100ms cubic-bezier(0.165, 0.84, 0.44, 1) 0s, transform 100ms cubic-bezier(0.165, 0.84, 0.44, 1) 0s;
}
.s-tag {
  display: inline-flex;
  align-content: center;
...
.s-sidebarwidget--subnav li[aria-current="true"],
.s-sidebarwidget--subnav li[aria-current="page"] {
  background-image: url("data:image/svg+xml,%3C?xml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22?%3E%3Csvg%20version%3D%221.1%22%20viewBox%3D%220%200%207%2010%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cpath%20d%3D%22m0.72153%200.68446%204.1336%204.3077-4.1336%204.3077%22%20fill%3D%22none%22%20stroke%3D%22var%28--orange%29%22%20stroke-width%3D%222%22/%3E%3C/svg%3E");
}
